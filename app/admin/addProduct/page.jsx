  ...
  return (
    <>
        <form onSubmit={onSubmitHandler} className='pt-5 px-5 sm:pt-12 pl-16'>
            ...
            <label htmlFor="image">
                <Image src={!image?assets.upload_area:URL.createObjectURL(image)} width={100} height={50} alt='' className='mt-4 border border-gray-500'/>
            </label>
            ...
            <textarea name='description' onChange={onChangeHandler} value={data.description}  placeholder='Write the content here..' rows={6} required className='w-full sm:w-[500px] mt-4 px-4 py-3 border'/>
